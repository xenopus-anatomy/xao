 ...
 * [xao.yml](xao.yml)
     * Determines how your purl.obolibrary.org/obo/xao/ redirects will be handled
     ...
     * Paste in the contents of [xao.yml](xao.yml)
 ...
 * [xao.md](xao.md)
     ...
     * Paste in the contents of [xao.md](xao.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
